...
Copyright 2005-${symbol_dollar}{ConfigProperties.current.year}  The Kuali Foundation.  All rights reserved.  Kuali is licensed for use pursuant to the Educational Community License v. 1.0.  Portions of Kuali are copyrighted by other parties,   including the parties listed below.  You should refer to the licenses directory for complete copyright and licensing information.  Questions about licensing should be directed to <span class="nobr"><a href="mailto:${symbol_dollar}{ConfigProperties.licensing.contact.email}" title="Send mail to ${symbol_dollar}{ConfigProperties.licensing.contact.email}" rel="nofollow">${symbol_dollar}{ConfigProperties.licensing.contact.email}</a></span></p>
...
<p>This product includes software developed by the Indiana University Extreme&${symbol_pound}33; Lab (<span class="nobr"><a href="http://www.extreme.indiana.edu/" title="extreme.indiana" rel="nofollow">http://www.extreme.indiana.edu/</a></span>).</p>
