...
/**
 * Creates a maven overlay for the given rice standalone prototype
 * 
 * @author Leo Przybylski (przybyls [at] arizona.edu)
 */
 @Mojo(
     name="create-sampleapp-overlay",
     requiresProject = false
     )
public class CreateSampleappOverlayMojo extends AbstractMojo {
    ...
    @Parameter(property = "kr.prototype.artifactId", defaultValue = "rice-sampleapp")
