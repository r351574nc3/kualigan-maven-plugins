...
<c:if test="${displayTitle}" >
  <a class="portal_link" href="${prefix}portal.do?channelTitle=${title}&channelUrl=../../../../${kuali.site.publish.url}/kuali-common/kfs-common/kfs-archetype"  title="${title}">${title}</a>
</c:if>
<c:if test="${! displayTitle}" >
  <a class="portal_link" href="${prefix}portal.do?channelTitle=${title}&channelUrl=../../../../${kuali.site.publish.url}/kuali-common/kfs-common/kfs-archetype" title="${title}"><jsp:doBody/></a>
</c:if>
